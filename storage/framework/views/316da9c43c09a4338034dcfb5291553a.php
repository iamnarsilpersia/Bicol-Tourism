<?php $__env->startSection('title', 'Book Custom Tour - Bicol Tourism'); ?>
...
<div class="container mx-auto px-4 pb-12">
    <form method="POST" action="<?php echo e(route('public.book-tour.store')); ?>" class="bg-white rounded-xl shadow-lg p-8">
        <?php echo csrf_field(); ?>
                ...
                <label class="border-2 border-gray-200 p-4 rounded-xl cursor-pointer hover:border-blue-500 hover:bg-blue-50 transition">
                    ...
                    <div class="inline-block">
                        ...
                        <?php if($spot->entry_fee > 0): ?>
                            <span class="text-green-600 text-sm">₱<?php echo e(number_format($spot->entry_fee, 2)); ?> entry fee</span>
                        <?php else: ?>
        ...
        <div class="mb-8">
            ...
            <div class="grid md:grid-cols-2 gap-4">
                ...
                <label class="border-2 border-gray-200 p-4 rounded-xl cursor-pointer hover:border-orange-500 hover:bg-orange-50 transition">
                    <input type="checkbox" name="selected_foods[]" value="<?php echo e($restaurant->id); ?>" class="mr-3 food-checkbox" data-price="<?php echo e($restaurant->price_range ?? 0); ?>">
                    <div class="inline-block">
                        <span class="font-bold text-gray-800"><?php echo e($restaurant->name); ?></span>
                        <span class="text-gray-500 text-sm block"><?php echo e($restaurant->cuisine_type); ?></span>
                        <?php if($restaurant->price_range): ?>
                            <span class="text-green-600 text-sm">₱<?php echo e(number_format($restaurant->price_range, 0)); ?> per person</span>
                        <?php endif; ?>
                    </div>
                </label>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
