<?php $__env->startSection('title', 'Interactive Map - Bicol Region'); ?>
...
const hotels = <?php echo json_encode($hotels, 15, 512) ?>;
const shops = <?php echo json_encode($shops, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\iamna\bicol-tourism\resources\views/admin/map/index.blade.php ENDPATH**/ ?>