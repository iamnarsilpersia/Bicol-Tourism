...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'User - Bicol Tourism'); ?></title>
...
<body class="bg-gray-50">
                ...
                <div class="flex items-center space-x-4">
                    <div class="flex items-center space-x-2">
                        <div class="w-8 h-8 bg-white rounded-full flex items-center justify-center">
                            <span class="text-blue-600 text-sm font-bold"><?php echo e(substr(Auth::user()->name, 0, 1)); ?></span>
                        </div>
    ...
    <footer class="bg-gray-800 text-white py-4 mt-8">
        <div class="container mx-auto px-4 text-center text-sm text-gray-400">
            <p>&copy; <?php echo e(date('Y')); ?> Bicol Tourism. All rights reserved.</p>
        </div>
    </footer>
</body>
</html><?php /**PATH C:\Users\iamna\bicol-tourism\resources\views/layouts/user.blade.php ENDPATH**/ ?>