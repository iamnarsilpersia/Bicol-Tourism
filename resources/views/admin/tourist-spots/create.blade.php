...
@section('title', 'Create Tourist Spot')

@section('content')
<h1 class="text-2xl font-bold mb-6">Add New Tourist Spot</h1>

<form method="POST" action="{{ route('admin.tourist-spots.store') }}" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow">
    @csrf
