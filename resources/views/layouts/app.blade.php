...
<head>
    ...
    <title>@yield('title', 'Bicol Tourism Guide')</title>
...
<body class="bg-gray-50">
        ...
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="{{ route('public.tourist-spots') }}" class="text-gray-700 hover:text-blue-600 font-medium">Destinations</a>
                    <a href="{{ route('public.tour-packages') }}" class="text-gray-700 hover:text-blue-600 font-medium">Packages</a>
                    <a href="{{ route('public.map') }}" class="text-gray-700 hover:text-blue-600 font-medium">Map</a>
                    <a href="{{ route('public.nearby-places', ['lat' => 13.444, 'lng' => 123.75]) }}" class="text-gray-700 hover:text-blue-600 font-medium">Nearby</a>
                </div>

                <div class="flex items-center space-x-4">
                    @auth
                        @if(Auth::user()->role === 'user')
                            <a href="{{ route('public.book-tour') }}" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 font-medium">Book Now</a>
                            <a href="{{ route('user.dashboard') }}" class="text-gray-700 hover:text-blue-600 font-medium">Dashboard</a>
                        @else
                            <a href="{{ route('admin.dashboard') }}" class="text-gray-700 hover:text-blue-600 font-medium">Admin Panel</a>
                        @endif
                        <div class="flex items-center space-x-2">
    ...
    <div class="md:hidden bg-white border-t py-2 px-4 flex justify-around">
        ...
        <a href="{{ route('public.tourist-spots') }}" class="text-gray-700 text-sm">Spots</a>
        <a href="{{ route('public.tour-packages') }}" class="text-gray-700 text-sm">Packages</a>
        <a href="{{ route('public.map') }}" class="text-gray-700 text-sm">Map</a>
    </div>
    ...
    <footer class="bg-gray-900 text-white mt-16">
        <div class="container mx-auto px-4 py-12">
            <div class="grid md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400 text-sm">
                        <li><a href="{{ route('public.tourist-spots') }}" class="hover:text-white">Tourist Spots</a></li>
                        <li><a href="{{ route('public.tour-packages') }}" class="hover:text-white">Tour Packages</a></li>
                        <li><a href="{{ route('public.map') }}" class="hover:text-white">Interactive Map</a></li>
            ...
            <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
                <p>&copy; {{ date('Y') }} Bicol Tourism Guide. All rights reserved.</p>
            </div>
        </div>
    </footer>
    @stack('scripts')
